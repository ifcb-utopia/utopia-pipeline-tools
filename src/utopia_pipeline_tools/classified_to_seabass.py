...
class MakeSeaBASS():
    def __init__(self, metadata_filepath, class_filepath, experiment, cruise, 
                 ...
                 investigator_info=upt.default_investigators, stations=True, 
                 flags=False, doc_list=None, data_status='final', 
                 trigger_mode='both', notes=None, sample_filepath=None, 
                 filepaths=None, config_info=upt.config_info, 
        ...
        :param investigator_info: Investigator information saved in a 
            dictionary. The dictionary must be of the form: {Firstname_Lastname: 
            [Org, email], Firstname_Lastname: [Org, email], ...}. Include no 
            spaces in the investigator or organization names.   
        :type investigator_info: dict  
        ...
        :param config_info: Dictionary of configuration information. Template
            in the __init__ file of this package.
        :type config_info: dict
        :param cal_ratio: The pixels:micrometer ratio of IFCB images. Default is 
            2.7488.
        :type cal_ratio: float, optional
        """
    ...
    def structure_data(self, sample_filename, sample_df):
        ...
        for x in np.arange(len(sample_df.index)):
            ...
            biovolume = round(sample_df['Biovolume'][x]/(
                self.cal_ratio**3), 3)
            area = round(sample_df['Area'][x]/(self.cal_ratio**2), 3)
